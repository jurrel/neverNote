...
//     const notesAtzero = notes[0]
//     const time = notesAtzero?.updatedAt
//     const epoctime = Date.parse(time);
//     // const finalTime = epoctime.getDate();

//     // console.log('what is updated at', finalTime)
//     // console.log('what is epoctime time', epoctime)
//     // console.log('date', Date.now())

//     const sortedTimelist = notes?.map(note =>{
//        let time = note.updatedAt
//        let newTime = Date.parse(time)
//        note.updatedAt = newTime
//        return note
//     })
//     const sortedlist = sortedTimelist?.sort((a, b) => b.updatedAt?.localeCompare(a.updatedAt))
...
//     const compare = (a,b) => new Date(b.updatedAt) - new Date(a.updatedAt);
